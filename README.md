...
![CI](https://github.com/spirosco/upbound-provider-aws/workflows/CI/badge.svg) [![GitHub release](https://img.shields.io/github/release/spirosco/upbound-provider-aws/all.svg?style=flat-square)](https://github.com/spirosco/upbound-provider-aws/releases) [![Go Report Card](https://goreportcard.com/badge/github.com/spirosco/upbound-provider-aws)](https://goreportcard.com/report/github.com/spirosco/upbound-provider-aws) [![Slack](https://slack.crossplane.io/badge.svg)](https://crossplane.slack.com/archives/C01TRKD4623) [![Twitter Follow](https://img.shields.io/twitter/follow/upbound_io.svg?style=social&label=Follow)](https://twitter.com/intent/follow?screen_name=upbound_io&user_id=788180534543339520)
...
Follow the quick start guide [here](https://marketplace.upbound.io/providers/spirosco/upbound-provider-aws/latest/docs/quickstart).

You can find a detailed API reference with all CRDs and examples [here](https://marketplace.upbound.io/providers/spirosco/upbound-provider-aws/latest/crds).
...
open an [issue](https://github.com/spirosco/upbound-provider-aws/issues).
