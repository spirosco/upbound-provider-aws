...
type OrderedCacheBehaviorFunctionAssociationParameters struct {
	...
	// ARN of the CloudFront function.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/cloudfront/v1beta1.Function
...
type OriginParameters struct {
	...
	// Unique identifier of a CloudFront origin access control for this origin.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/cloudfront/v1beta1.OriginAccessControl
...
type S3OriginConfigParameters struct {
	...
	// The CloudFront origin access identity to associate with the origin.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/cloudfront/v1beta1.OriginAccessIdentity
