...
type AutoscalingGroupParameters struct {
	...
	// Name of the launch configuration to use.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/autoscaling/v1beta1.LaunchConfiguration
	// +kubebuilder:validation:Optional
	LaunchConfiguration *string `json:"launchConfiguration,omitempty" tf:"launch_configuration,omitempty"`
	...
	// Name of the placement group into which you'll launch your instances, if any.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/ec2/v1beta1.PlacementGroup
