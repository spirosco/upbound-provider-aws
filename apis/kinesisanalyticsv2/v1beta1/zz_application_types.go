...
type CloudwatchLoggingOptionsParameters struct {
	...
	// The ARN of the CloudWatch log stream to receive application messages.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/cloudwatchlogs/v1beta1.Stream
...
type S3ContentLocationParameters struct {
	...
	// The file key for the object containing the application code.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/s3/v1beta1.Object
