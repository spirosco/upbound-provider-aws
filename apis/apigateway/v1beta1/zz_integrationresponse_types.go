...
type IntegrationResponseParameters struct {
	...
	// HTTP method (GET, POST, PUT, DELETE, HEAD, OPTIONS, ANY).
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/apigateway/v1beta1.Method
	...
	// API resource ID.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/apigateway/v1beta1.Resource
	...
	// HTTP status code.
	// +crossplane:generate:reference:type=github.com/spirosco/upbound-provider-aws/apis/apigateway/v1beta1.MethodResponse
